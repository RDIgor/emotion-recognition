from src.models.rcnn.processing.generate_anchor import generate_anchors_fpn, anchors_plane
from src.models.rcnn.processing.nms import gpu_nms_wrapper, cpu_nms_wrapper
from src.models.rcnn.processing.bbox_transform import clip_boxes
...
class RetinaFaceModel:
    ...
    def predict(self, img, threshold=0.5, scales=[1.0], do_flip=False):
